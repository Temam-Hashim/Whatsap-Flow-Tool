...
public class FlowData {
    ...
    public static final Map<String, Object> SCREEN_RESPONSES = new HashMap<String, Object>() {{
    ...
    public static final Map<String, Map<String, String>> LOAN_OPTIONS = new HashMap<String, Map<String, String>>() {{
